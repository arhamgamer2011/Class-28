...
var backgroundMusic, cannonexplosionMusic, waterMusic, piratelaughMusic;
...
function preload() {
  ...
  piratelaughMusic = loadSound("./assets/pirare_laugh.mp3")
}
    ...
    for (var i = 0; i < boats.length; i++) {
      if (boats[i]) {
        ...
        if(collision.collided && !boats[i].isBroken) {
          if(!isLaughing && !piratelaughMusic.isPlaying()) {
